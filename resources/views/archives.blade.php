...
@section('content')
    ...
    <main id="main" role="main">
        ...
        <header class="page-head wow fadeInLeft" data-wow-delay="0.6s"
        ...
        <div id="twocolumns" class="container">
            ...
            <div class="row">
                ...
                <div id="content" class="col-xs-12 col-md-8">
                    ...
                    <!-- Widget of the page -->
                    <section class="widget profile-widget version-ii hidden-lg hidden-md wow fadeInLeft"
                             data-wow-delay="0.6s">
                    ...
                    <section class="posts-blocks">
                        ...
                        <article class="post-block wow fadeInLeft" data-wow-delay="0.6s">
                            <div class="post-holder">
                                <div class="img-holder">
                                    <a href="single-post.html"><img src="http://placehold.it/375x245"
                        ...
                        <article class="post-block wow fadeInLeft" data-wow-delay="0.6s">
                            <div class="post-holder">
                                <div class="video-holder">
                                    <a href="https://player.vimeo.com/video/133306855"
                                       class="ico-play lightbox fancybox.iframe"></a>
                                    <img src="http://placehold.it/375x245" alt="image description">
                                </div>
                                <time datetime="2011-01-12"><a href="#">25th May - Travel</a></time>
                                <h2><a href="single-post.html">I get up in the morning looking for adventure.</a></h2>
                                <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh
                    ...
                    <div id="tab1">
                        <ul>
                            ...
                            <li>
                                ...
                                <div class="descr">
                                    <h4><a href="single-post.html">I get up in the morning looking <br>for an adventure.</a>
                                    </h4>
                                    <span class="post-tag">
														<time datetime="2011-01-12"><a href="#">25th may</a></time>
													</span>
            ...
            <div class="widget widget_categories version-ii wow fadeInUp" data-wow-delay="0.6s">
                ...
                <ul>
                    ...
                    <li class="cat-item cat-item-1"><span><a href="#">- Travel</a></span><span><a href="#">- Travel</a></span>
                    </li>
                    <li class="cat-item cat-item-1"><span><a href="#">- Sports</a></span><span><a href="#">- Sports</a></span>
                    </li>
